...
class Server::SyncRequestThreadManager : public ThreadManager {
 public:
  SyncRequestThreadManager(Server* server, CompletionQueue* server_cq,
                           ...
                           int min_pollers, int max_pollers, int max_threads,
                           int cq_timeout_msec)
...
Server::Server(
    ...
    std::shared_ptr<std::vector<std::unique_ptr<ServerCompletionQueue>>>
        sync_server_cqs,
    int min_pollers, int max_pollers, int max_threads, int sync_cq_timeout_msec)
  ...
  for (auto it = sync_server_cqs_->begin(); it != sync_server_cqs_->end();
    ...
    sync_req_mgrs_.emplace_back(new SyncRequestThreadManager(
        this, (*it).get(), global_callbacks_, min_pollers, max_pollers, max_threads,
